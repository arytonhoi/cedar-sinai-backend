...
//         ];
//         imageFilenName = `${Math.round(
//             Math.random() * 100000000000
//         )}.${imageExtension}`;
//         const filepath = path.join(os.tmpdir(), imageFilenName);
...
//             })
//             .then(() => {
//                 const imageUrl = `https://firebasestorage.googleapis.com/v0/b/${firebaseConfig.storageBucket}/o/${imageFilenName}?alt=media`;
//                 return db
